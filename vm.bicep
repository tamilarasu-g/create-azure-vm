...
param virtualNetworkName string = 'bicep-vnet'

@description('Name of the subnet in the virtual network')
param subnetName string = 'bicep-subnet'

@description('Name of the Network Security Group')
param networkSecurityGroupName string = 'bicep-nsg'
...
var publicIPAddressName = '${vmName}bicep-ip'
var networkInterfaceName = '${vmName}bicep-nic'
